...
export const RULES: Rule[] = [
  ...
  {
    keywords: ["papierkram", "orakel", "rag system", "hybrid search", "sqlite-vec", "bm25", "wissensbasis", "dokumente fragen", "reciprocal rank fusion", "github", "open source"],
    answer: "Papierkram-Orakel: Ein lokales RAG-System, das private Dokumente (Anleitungen, Verträge, Garantien) in eine befragbare Wissensbasis verwandelt — Hybrid Search aus Vektor-Suche (sqlite-vec) und BM25, Cross-Encoder-Reranking und Antworten mit exakter Quellenangabe. Passt ein Wissensgebiet ins Kontextfenster, geht es komplett ans LLM; das LLM-Backend ist frei austauschbar, auf Wunsch komplett lokal via Ollama. Mit eigener Case Study auf dieser Seite und Open Source auf GitHub.",
  },
  {
...
export const RULES_EN: Rule[] = [
  ...
  { keywords: ["papierkram", "orakel", "rag system", "hybrid search", "sqlite-vec", "bm25", "knowledge base", "query documents", "reciprocal rank fusion", "github", "open source"], answer: "Papierkram-Orakel: A local RAG system that turns private documents (manuals, contracts, warranties) into a queryable knowledge base — hybrid search combining vector search (sqlite-vec) and BM25, cross-encoder reranking, and answers with exact source references. If a knowledge domain fits into the context window, it all goes to the LLM; the LLM backend is fully swappable, fully local via Ollama if desired. Has its own case study on this site and is open source on GitHub." },
